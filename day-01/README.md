...
Нажмите `Enter`, чтобы отправить сообщение. Используйте `Alt+Enter` для новой строки. Диалог продолжается, пока работает процесс. Для завершения нажмите `Ctrl+C`, `Ctrl+D`, введите `exit` или `quit`.
